...
struct ResultModalTestView: View {
    ...
    // 여기 데이터랑 연결
    // 여기서 result뷰 라우팅은 됐고
    // 시작 -> 3,2,1 -> 여기 -> result 뷰 -> reward 뷰 -> 메인뷰
                    ...
                    VStack(spacing: 6) {
                        Button(action: {
                            ...
                            RoundedRectangle(cornerRadius: 10)
                                .fill(
                                    isLocationActive ? Color.yellow : Color.black
                                )
                        ...
                        HStack(spacing: 80) {
                            VStack(spacing: 24) {
                                VStack {
                                    Text("132,911")
                                        .font(.title01)
                                        .foregroundColor(.white) // 실시간 영역 계산값
                                    Text("영역(m²)")
                                        .font(.title01)
                            ...
                            VStack(spacing: 24) {
                                ...
                                VStack {
                                    Text("78.13")
                                        .font(.title01)
                                        .foregroundColor(.white) // 실시간 칼로리 계산값
                                    Text("kcal")
                                        .font(.title01)
                                        .foregroundColor(.gray)
                                }
                    ...
                    HStack {
                        ...
                        Button(action: {
                            ...
                            Circle()
                                ...
                                .overlay(
                                    Image(
                                        systemName: showDetailInfo ? "chevron.down" : "chevron.up"
                                    )
